...
image=cv2.imread('License-Plate-Detection-OpenCV-and-Py-Tesseract\CarPictures\car.jpg')
...
frequency = 2500
duration = 1200
if check_if_string_in_file('License-Plate-Detection-OpenCV-and-Py-Tesseract\Database\Database.txt', text) and text != "":
    print('Registered')
